...
class EraserTool:
    ...
    def mouseMoveEvent(self, e: QtGui.QMouseEvent):
        ...
        p.setPen(QPen(Qt.black, self.win.eraser_width, Qt.SolidLine, Qt.RoundCap, Qt.RoundJoin))
    ...
    def mouseReleaseEvent(self, e: QtGui.QMouseEvent):
        ...
        self.win.state.strokes().append(Stroke(t="line", points=pts, rgba=(0,0,0,0),
    ...
    def keyPressEvent(self, e: QtGui.QKeyEvent):
        ...
        if key in (Qt.Key_BracketLeft, Qt.Key_BracketRight):
            ...
            self.win.adjust_eraser_width(step if key == Qt.Key_BracketRight else -step)
